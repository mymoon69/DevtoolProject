      ...
      <div class="my-4">
        ...
        <div class="flex flex-row items-center justify-center">
          ...
          >
            ...
            <div class="flex justify-center items-center">
              <button
                class="rounded-md bg-[#3A4646] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                @click="godayselect(0)"
              >
                Go
              </button>
              ...
              <button
                class="rounded-md bg-[#3A4646] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 m-3 todaybtn"
                @click="gototoday()"
              >
                Today
              </button>
...
export default {
  ...
  methods: {
    ...
    getactiveday(date) {
      ...
      /*  this.date1=dayname + " "+ date + " " + months[this.month] + " " + this.year;
        this.date2=dayname + " "+ date + " " + months[this.month] + " " + this.year; */
