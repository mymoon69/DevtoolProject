...
<template>
    <div class="m-10">
        ...
        <div class="w-full  order-solid border-2 border-grey-500 p-2 mt-2 rounded">
            ...
            <textarea class=" w-full p-2" name="" id="" cols="30" rows="5"></textarea>
            ...
            <div class="flex mt-2">
                ...
                <div class=" w-full  flex justify-end">
                    <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-2 rounded ">Comment</button>
                </div>
            </div>
        ...
        <div class="w-full mt-10">
            ...
            <div class="w-full pt-5">
                    <h1>Folks sldfkasdfkasdklfaksdljfaldfkj</h1>
            </div>
        ...
        <div class="w-full" v-show="showHiddenDiv2">
            <div class="w-full mt-10">
                <div class="flex">
                    <img class="object-cover w-10 h-10 rounded-full mr-5"
                        src="https://static.thairath.co.th/media/dFQROr7oWzulq5Fa5K33rPih0ekXpdjTYJZMA1xjXzItlZVde9muslF5HbRKeGtfS5w.jpg"
            ...
            <button class="w-full mt-10 bg-gray-300 hover:bg-gray-200 p-2 rounded" @click="toggleHiddenDiv"> Load More</button>
